                ...
                <a href="<?php echo $url ?>" target="<?php echo $blank ?>" class="cardTrigger"  title="<?php echo $title ?>">
                    <div class="card-layout">
                        <div class="wrap-icon">
                            ...
                            <img class="img-circle fix lazy" src="<?php echo $default_ico; ?>" data-src="<?php echo get_post_meta($post->ID, '_thumbnail', true)? get_post_meta($post->ID, '_thumbnail', true): (io_get_option('ico_url') .format_url($link_url) . io_get_option('ico_png')) ?>" onerror="javascript:this.src='<?php echo $default_ico; ?>'" width="40" height="40" loading="lazy" decoding="async">
                            <?php else: ?>
                            <img class="img-circle fix lazy" src="<?php echo get_post_meta($post->ID, '_thumbnail', true)? get_post_meta($post->ID, '_thumbnail', true): (io_get_option('ico_url') .format_url($link_url) . io_get_option('ico_png')) ?>" onerror="javascript:this.src='<?php echo $default_ico; ?>'" width="40" height="40" loading="lazy" decoding="async">
                            <?php endif ?>
                        </div>
